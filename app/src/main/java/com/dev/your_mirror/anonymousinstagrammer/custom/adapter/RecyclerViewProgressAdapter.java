package com.dev.your_mirror.anonymousinstagrammer.custom.adapter;
...
abstract public class RecyclerViewProgressAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected List<T> dataSet = new ArrayList<T>();
    ...
    public static class ProgressViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProgressViewHolder(View v) {
            super(v);
            progressBar = (ProgressBar) v.findViewById(R.id.spinner_progress_bar);
        }
    }

    public RecyclerView.ViewHolder onCreateFooterViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.spinner_progress_bar, parent, false);
